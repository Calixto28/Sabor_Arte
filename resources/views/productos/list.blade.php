    ...
    <table class="table table-striped-secondary mb-5">
        <thead>
            <tr class="color-white">
                <th scope="col">#</th>
                <th scope="col" style="min-width:270px;">Descripción</th>
                <th scope="col" style="min-width:270px;">Categoría</th>
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $data['id'] }}</td>
                <td style="min-width:270px;">{{ $data['producto_descripcion'] }}</td>
                <td style="min-width:270px;">{{ $data['categoria_descripcion'] }}</td>
